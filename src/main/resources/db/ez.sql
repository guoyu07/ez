...
-- 正在导出表  ez.sys_permission 的数据：~6 rows (大约)
...
-- 正在导出表  ez.sys_resource 的数据：~47 rows (大约)
...
-- 正在导出表  ez.sys_role 的数据：~10 rows (大约)
...
-- 导出  表 ez.sys_role_resource_permission 结构
...
-- 正在导出表  ez.sys_role_resource_permission 的数据：~27 rows (大约)
...
-- 正在导出表  ez.sys_user 的数据：~10 rows (大约)
...
-- 正在导出表  ez.sys_user_role 的数据：~10 rows (大约)
